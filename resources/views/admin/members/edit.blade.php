    ...
    <div class="col-lg-12 col-md-12">
        <div  class="card">
            ...
            <div class="card-body">
                ...
                <form id="updateMember" action="{{route('members.update', $member->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="row row-sm mb-4">
                    <div class="col-lg">
                        ...
                        <input class="form-control" placeholder="User Name" name="name" value="{{ $member->name}}" type="text" required>
                        @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-lg">
                        ...
                        <input class="form-control" placeholder="User Email" value="{{ $member->email}}" readonly type="email" required>
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>

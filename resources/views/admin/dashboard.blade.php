      ...
      <div class="card-body">
        <div class="d-flex align-items-end justify-content-between">
          <div>
            ...
            <h2 class="mb-0"><span class="number-font1">{{ $members }}
            </span>
            {{-- <span class="ml-2 text-muted fs-11">
              <span class="text-success">
                <i class="fa fa-caret-up"></i> 19.8
              </span> this month
            </span> --}}
          </h2>
          </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-end justify-content-between">
          <div>
            ...
            <h2 class="mb-0"><span class="number-font1">{{ $jobs }}</span>
              {{-- <span class="ml-2 text-muted fs-11"><span class="text-success"><i class="fa fa-caret-up"></i> 0.8%</span> this month</span> --}}
            </h2>
          </div>
  ...
  <div class="col-xl-4  col-md-12">
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-end justify-content-between">
          <div>
            <p class=" mb-1 fs-14">Job Occupation</p>
            <h2 class="mb-0"><span class="number-font1">{{ $occupations }}</span>
              {{-- <span class="ml-2 text-muted fs-11"><span class="text-danger"><i class="fa fa-caret-down"></i> 43.2</span> this month</span> --}}
            </h2>
      ...
      <div class="card-body">
        <div class="row mb-3">
          <div class="col-xl-3 col-6">
            ...
            <h3 class="mb-0 fs-20 number-font1">$0</h3>
            <p class="fs-12 text-muted"><span class="text-danger mr-1"><i class="fe fe-arrow-down"></i>0%</span>this month</p>
          </div>
          <div class="col-xl-3 col-6 ">
            <p class=" mb-1">Maximum Sales</p>
            <h3 class="mb-0 fs-20 number-font1">$0</h3>
            <p class="fs-12 text-muted"><span class="text-success mr-1"><i class="fe fe-arrow-up"></i>0%</span>this month</p>
          </div>
          <div class="col-xl-3 col-6">
            <p class=" mb-1">Total ACV this Quarter</p>
            <h3 class="mb-0 fs-20 number-font1">$0</h3>
            <p class="fs-12 text-muted"><span class="text-danger mr-1"><i class="fe fe-arrow-down"></i>0%</span>this month</p>
          </div>
          <div class="col-xl-3 col-6">
            <p class=" mb-1">Total Sales per Anum</p>
            <h3 class="mb-0 fs-20 number-font1">$0</h3>
            <p class="fs-12 text-muted"><span class="text-success mr-1"><i class="fe fe-arrow-up"></i>0%</span>this month</p>
          </div>
        </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="country-card">
          ...
          @php
          $bgColor = ['bg-secondary','bg-info','bg-success','bg-danger','bg-teal','bg-indigo','bg-warning' , 'bg-info']
        @endphp
          
        @forelse ($user_info as $key => $data)
          @if(isset($data->occupation))
            <div class="mb-5">
              <div class="d-flex">
                <span class=""></span>
                <div class="ml-auto"><span class="text-success mr-1"><i class="fe fe-trending-up"></i></span><span class="number-font">{{ $data->total }}</span> (0%)</div>
              </div>
              <div class="progress h-2  mt-1">
                <div class="progress-bar progress-bar-striped progress-bar-animated {{ $bgColor[$key] ? $bgColor[$key] : ''  }}" style="width: 80%"></div>
              </div>
            </div>
            @endif
          @empty
        ...
        @endforelse
          ...
          <div class="mb-5">
            <div class="d-flex">
              <span class="">Business Consulting</span>

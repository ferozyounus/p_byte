  ...
  <div class="container-fluid">
    <div class="d-flex">
      <a class="header-brand" href="{{ route('home') }}">
        <img src="{{asset('admin/images/brand/logo.png')}}" class="header-brand-img desktop-lgo" alt="Admitro logo">
        <img src="{{asset('admin/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="Admitro logo">
        <img src="{{asset('admin/images/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="Admitro logo">
        <img src="{{asset('admin/images/brand/favicon1.png')}}" class="header-brand-img darkmobile-logo" alt="Admitro logo">
      </a>
        ...
        <div class="dropdown profile-dropdown">
            ...
            <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
              <span>
                ...
                <img src="{{ asset('storage/'.Auth::user()->image) }}" alt="img" class="avatar avatar-md brround">

                @else
                
                <img src="{{asset('admin/images/users/2.jpg')}}" alt="img" class="avatar avatar-md brround">
                @endif
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
            ...
            <a class="dropdown-item d-flex" style="cursor: pointer;" data-target="#modaldemo2" data-toggle="modal">
...
<div class="page-header" style="display:none;">
  <div class="page-leftheader">
    <h4 class="page-title mb-0">Hi! Welcome {{Auth::user()->name}}</h4>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="#"><i class="fe fe-home mr-2 fs-14"></i>Home</a></li>
      <li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ isset($page_title) ? $page_title : '' }}</a></li>
